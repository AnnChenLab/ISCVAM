###
#this script is an example of how to update user-specified annotation
# inputs will be R objects resulting from multiome analysis pipeline
# outputs will be these updated R objects with user-defined cell curation
...
######
#update clustering layers according to updated curated names
...
#############
### update curated names in Seurat object
